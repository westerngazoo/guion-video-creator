# Documentación — guion-video-creator

Specification repo for physics reel video pipeline
...
Target: guion + motoreel + garust + physics-lab/mecanica; legacy Python retiring
...
- [guion](../guion/)
- [fisicobuenfisico](../fisicobuenfisico/)
- [fitAI](../fitAI/)
